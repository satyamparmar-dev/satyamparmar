...
const KafkaCourseHome: React.FC = () => {
  usePageTitle('Apache Kafka Course');
  ...
  const handleStartPhase = (phaseNumber: number) => {
    ...
    if (target) navigate(`/kafka-course/lesson/${target.id}`);
  };
    ...
    <Box className="fade-in" sx={{ maxWidth: 1100, mx: 'auto' }}>
      ...
      <Paper
        ...
        sx={{
          ...
          borderColor: 'divider',
          background: isDark
            ? `linear-gradient(135deg, ${alpha('#f59e0b', 0.15)} 0%, ${alpha('#ef4444', 0.1)} 50%, transparent 100%)`
            : `linear-gradient(135deg, ${alpha('#f59e0b', 0.12)} 0%, ${alpha('#ef4444', 0.07)} 50%, ${theme.palette.background.paper} 100%)`,
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        ...
        <Box sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            From absolute beginner to enterprise patterns — in 5 phases. No heavy jargon.
            Every concept explained with a real-world analogy, then backed by working Spring Boot code.
          </Typography>
          ...
          >
            {[
              ...
              { icon: <SchoolIcon sx={{ fontSize: 16 }} />, label: '5 Phases' },
          ...
          {totalCompleted === 0 && (
            <Button
              ...
              onClick={() => navigate('/kafka-course/lesson/p1-l1')}
              sx={{
                bgcolor: '#f59e0b',
                color: '#fff',
                fontWeight: 700,
                  ...
                  {phaseLessons.slice(0, 4).map((lesson) => {
                    ...
                    return (
                      <Box
                        ...
                        onClick={() => navigate(`/kafka-course/lesson/${lesson.id}`)}
                      >
                        {isDone ? (
        ...
        >
          ...
          <Button
            ...
            onClick={() => {
              ...
              if (next) navigate(`/kafka-course/lesson/${next.id}`);
            }}
            sx={{
              bgcolor: '#f59e0b',
              color: '#fff',
      ...
      {totalCompleted === totalLessons && (
        ...
        >
          ...
          <Box>
            ...
            <Typography variant="caption" color="text.secondary">
              You have completed all {totalLessons} lessons. You are interview ready.
            </Typography>
          </Box>
        </Paper>
      )}
...
export default KafkaCourseHome;
