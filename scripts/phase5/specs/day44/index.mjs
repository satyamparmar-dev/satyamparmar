...
const exercise = {
  ...
  hints: [
    ...
    "Package arch.day44, class Day44Exercise.",
  ],
  solution: String.raw`package arch.day44;
...
const cheatsheetRows = [["JpaRepository","CRUD","interface"],["@Query","JPQL","custom"],["EntityGraph","fetch plan","hint"],["JOIN FETCH","eager join","fix N+1"],["LazyInitializationException","no session","open-in-view debate"],["@Transactional","service","boundary"],["flush","persist order","write"],["CascadeType","graph ops","careful"],["ddl-auto","dev only","prod migrate"],["Second level cache","optional","tuning"],["Specification","dynamic","criteria"],["Paging","Pageable","sort"],["Projection","DTO","interface"],["@Version","optimistic","lock column"],["StatelessSession","batch","rare"]];

export default {
  title: "Spring Data JPA & Hibernate",
  tags: ["Mid-Level", "Advanced", "Phase 5", "Interview Prep", "Spring", "Satyverse(Satyam Parmar)"],
  prerequisites: ["Day 43", "Day 42"],
  learningObjectives: [
    "Explain Spring Data JPA & Hibernate with production-oriented clarity",
  ...
  mcqDescription: "Thirty questions on repositories, Hibernate, and query pitfalls.",
  mcqQuestions,
  cheatsheetRows,
};
