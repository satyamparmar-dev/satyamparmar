...
import { buildDay89Sections } from './day89-builder.mjs';

const __dirname = dirname(fileURLToPath(import.meta.url));
const filePath = join(__dirname, '..', 'public', 'data', 'days', 'phase10-day89.json');
...
function verify(json) {
  ...
  return {
    ...
    hasFresherEx: !!fresherEx && /Day89FresherExercise/.test(fresherEx.solution || ''),
    hasStaffEx: !!staffEx && /Day89StaffExercise/.test(staffEx.solution || ''),
...
console.log('Patches applied:', patched ? 'full day 89 rebuild' : '(none)');
