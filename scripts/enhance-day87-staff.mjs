...
import { buildDay87Sections } from './day87-builder.mjs';

const __dirname = dirname(fileURLToPath(import.meta.url));
const filePath = join(__dirname, '..', 'public', 'data', 'days', 'phase10-day87.json');
...
function verify(json) {
  ...
  return {
    ...
    hasFresherEx: !!fresherEx && /Day87FresherExercise/.test(fresherEx.solution || ''),
    hasStaffEx: !!staffEx && /Day87StaffExercise/.test(staffEx.solution || ''),
...
console.log('Patches applied:', patched ? 'full day 87 rebuild' : '(none)');
