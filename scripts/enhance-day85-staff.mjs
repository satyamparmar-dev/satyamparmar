...
import { buildDay85Sections } from './day85-builder.mjs';

const __dirname = dirname(fileURLToPath(import.meta.url));
const filePath = join(__dirname, '..', 'public', 'data', 'days', 'phase10-day85.json');
...
function verify(json) {
  ...
  return {
    ...
    hasFresherEx: !!fresherEx && /Day85FresherExercise/.test(fresherEx.solution || ''),
    hasStaffEx: !!staffEx && /Day85StaffExercise/.test(staffEx.solution || ''),
...
console.log('Patches applied:', patched ? 'full day 85 rebuild' : '(none)');
